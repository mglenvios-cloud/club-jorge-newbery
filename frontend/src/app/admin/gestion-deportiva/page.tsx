              ...
              <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                ...
                {mediaTab === 'upload' && (
                  <div className="space-y-3">
                    <label className="border-2 border-dashed border-blue-500/30 hover:border-blue-500 rounded-2xl p-6 text-center block cursor-pointer transition-all bg-blue-500/5">
                      <UploadCloud className="w-9 h-9 text-blue-400 mx-auto mb-2 animate-pulse" />
                      <span className="text-xs font-bold text-white block">📁 Seleccionar archivo desde la PC</span>
                      <span className="text-[11px] text-slate-400 block mt-1">Soporta JPG, PNG, WEBP. La imagen se previsualiza al instante.</span>
                ...
                {mediaTab === 'url' && (
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-slate-300">URL Directa de la Foto</label>
                    <input
                      type="text"
                      placeholder="https://..."
                      value={urlInput}
                ...
                {/* Preview Box */}
                {photoPreview && (
                  <div className="flex items-center gap-4 p-3 rounded-xl bg-slate-900 border border-emerald-500/40">
                    <img src={photoPreview} alt="Preview" className="w-14 h-14 rounded-xl object-cover border-2 border-emerald-400 shadow-md" />
                    <div>
                      <span className="text-xs font-bold text-white block">✓ Vista Previa de la Foto Lista</span>
                      <span className="text-[10px] text-emerald-400 font-semibold">Foto cargada correctamente.</span>
                    </div>
                  </div>
                )}
              </div>
