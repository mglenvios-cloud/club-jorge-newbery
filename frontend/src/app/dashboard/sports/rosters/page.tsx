...
export default function RostersPage() {
  ...
  const handleSavePlayer = async (e: React.FormEvent) => {
    ...
    if (!newPlayerData.firstName || !newPlayerData.lastName) {
      setNotification({ type: 'error', text: 'Por favor ingrese Nombre y Apellido.' });
      return;
    }
    ...
    setNotification({ type: 'success', text: `¡Jugador ${createdAthlete.firstName} ${createdAthlete.lastName} registrado con éxito!` });
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Planteles & Fichas Médicas de Deportistas</h1>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
          <div className="glass-card w-full max-w-2xl rounded-3xl border border-slate-800 p-6 space-y-6 relative animate-in fade-in zoom-in-95">
            {/* Modal Header */}
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Complete la ficha técnica e ingrese o suba la fotografía oficial.</p>
                </div>
              </div>
